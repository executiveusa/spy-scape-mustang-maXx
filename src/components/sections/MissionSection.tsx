        ...
        <div className="grid md:grid-cols-2 gap-4">
          {panels.map((panel, i) => (
            ...
            >
              ...
              {/* Film-frame sweep on hover */}
              <motion.div
                className="absolute inset-0 bg-gradient-to-r from-transparent via-maxx-cyan/6 to-transparent opacity-0 group-hover:opacity-100 -translate-x-full group-hover:translate-x-full transition-all duration-700"
              />
