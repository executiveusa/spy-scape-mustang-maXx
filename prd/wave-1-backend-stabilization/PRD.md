# Wave 1: Backend Stabilization and Real Hermes Execution
...
- real Hermes-backed Lead Desk execution when provider credentials are available
...
- `/v1/hermes/health` reports provider readiness honestly
